...
__attribute__((section("__versions"))) = {
	...
	{ 0xec7168bc, __VMLINUX_SYMBOL_STR(es8328_probe) },
	...
	{ 0x9f1d7679, __VMLINUX_SYMBOL_STR(es8328_regmap_config) },
};

static const char __module_depends[]
__used
__attribute__((section(".modinfo"))) =
"depends=snd-soc-es8328";

MODULE_ALIAS("of:N*T*Ceverest,es8328*");

MODULE_INFO(srcversion, "4FF9D9039D7FACF451A4A34");
