...
__attribute__((section("__versions"))) = {
	...
	{ 0x7957fd9, __VMLINUX_SYMBOL_STR(snd_ctl_get_preferred_subdevice) },
	{ 0xefd6cf06, __VMLINUX_SYMBOL_STR(__aeabi_unwind_cpp_pr0) },
	{ 0xe541f682, __VMLINUX_SYMBOL_STR(snd_seq_device_new) },
...
MODULE_INFO(srcversion, "23DA02AA66C11046CCEC268");
